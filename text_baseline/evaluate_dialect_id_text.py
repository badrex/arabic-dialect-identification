...
import joblib
from train_dialect_id_text import ArabicDialectIdentifier
...
def evaluate_on_new_dataset(model_path, dataset_name, text_column, label_column):
    ...
    for domain in dataset_domains: #['in-domain'] :# dataset_domains:
        if domain == "Wikipedia":
            continue
...
if __name__ == "__main__":
    ...
    MODEL_PATH = "models/dialect_classifier.joblib"
